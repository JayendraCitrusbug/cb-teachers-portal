          ...
          <div className="flex flex-col md:flex-row items-start gap-6 relative self-stretch w-full">
            ...
            <div className="flex-col items-start gap-3 flex-1 grow flex">
              ...
              <Select>
                ...
                <SelectContent style={{ background: "white" }}>
                  <SelectItem value="student1">Alex Johnson</SelectItem>
                  <SelectItem value="student2">Sarah Khan</SelectItem>
                  <SelectItem value="student3">David SK</SelectItem>
                  <SelectItem value="student4">Jhon Michal</SelectItem>
                </SelectContent>
              </Select>
            </div>

            <Button variant="outline" className="h-10 mt-auto">
              Manage Classes
            </Button>
          </div>
          ...
          <section className="flex flex-col items-start gap-6 w-full">
            <div className="flex flex-col items-start gap-5 w-full">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 w-full">
                <Card className="w-full md:w-[390px] shadow-shadow-sm">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-end justify-between">
                      <div className="flex flex-col items-start gap-3">
                        ...
                        <div className="font-medium text-zinc-500 text-lg leading-5">
                          Period 1 Biology
                        </div>
                      </div>
                ...
                <Card className="w-full md:w-[390px] shadow-shadow-sm">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-end justify-between">
                      <div className="flex flex-col items-start gap-3">
                        <div className="flex items-center gap-6">
                          <div className="w-[151px] h-[31px]">
                            <div className="font-bold text-zinc-900 text-[27.7px] leading-[30.7px]">
                              Life Cycles
                            </div>
                          </div>
                        </div>
                      ...
                      <Button className="bg-[#34c759] hover:bg-[#34c759]/90">
                        Add
                      </Button>
                    </div>
                  </CardContent>
