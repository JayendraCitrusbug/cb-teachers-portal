...
const AddLessonCard: React.FC<AddLessonCardProps> = ({
  title,
  description,
  children,
}) => {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-[9999] -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg w-full max-w-5xl shadow-lg focus:outline-none">
          <p className="font-[family-name:var(--font-geist-sans)]">
            Tell your AI teacher assistant What you are teaching in Class this
            week.
          </p>
          ...
          <p className="text-sm text-gray-700 mb-4">
            Learning standard:{" "}
            <span className="font-medium">CCSS.MATH.CONTENT.</span>
          </p>
          ...
          <div className="w-full justify-center items-center flex mt-4 flex-col md:flex-row gap-4">
            ...
            <AddLessonCard
              title="Upload"
              description="Upload Many Lessons ( eBook, Lessons Plans etc )"
            >
              <Image
                className="w-[55px] h-[55px]"
                alt="G"
