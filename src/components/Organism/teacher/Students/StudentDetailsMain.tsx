...
import { StudentDetailsHeader } from "@/components/Organism/teacher/Students";
...
const StudentDetailsPage = () => {
  ...
  const currentStudent = students?.find(
    (student) => student.name === decodeURI(student_id as string)
  );

  const [activeTab, setActiveTab] = useState<
    "learning_insights" | "overview" | "status"
  >("overview");
        ...
        {currentStudent && (
          <>
            ...
            {activeTab === "learning_insights" && (
              <StudentDetailsLearningInsights />
            )}
