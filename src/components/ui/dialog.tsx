...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      "fixed inset-0 z-50",
      // Use a semi-transparent black overlay instead of white
      "bg-white/65",
...
>(({ 
  ...
  title, 
  showTitle = true, 
  description = "This dialog window provides additional information or actions.", 
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "border bg-white p-6 shadow-lg", // Make sure this background is white
